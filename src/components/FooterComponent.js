                ...
                <div className="row justify-content-center">             
                    ...
                    <div className="col-5 col-md-4 align-self-center">
                        <div className="text-center">
                            <a className="btn btn-social-icon btn-github" href="https://github.com/DhrumilShah26/Weather-API" target="_blank" rel="noopener noreferrer"><i className="fa fa-github"></i></a>
